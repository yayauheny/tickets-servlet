...
public class ConsoleInputServiceImpl implements ConsoleInputService {
    private static ConsoleInputServiceImpl INSTANCE;

    public static ConsoleInputServiceImpl getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new ConsoleInputServiceImpl();
        }
        return INSTANCE;
    }
@Override
    ...
    private static Card findCard(Map<String, String> stringMap) throws InputException {
        ...
        return CardDao.getInstance().findById(cardNumber)
        ...
        try {
            stringMap.entrySet().stream()
                    ...
                    .forEach(entry -> {
                        ...
                        Product foundProduct = ProductDao.getInstance().findById(id).get();
